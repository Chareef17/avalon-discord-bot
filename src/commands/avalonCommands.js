...
export function createAvalonCommands() {
  const avalon = {
    data: new SlashCommandBuilder()
      ...
      .addSubcommand((sub) =>
        sub
          .setName('setup')
          .setDescription('สร้างเกม Avalon ใหม่ในช่องนี้'),
      )
      .addSubcommand((sub) =>
        sub
          .setName('join')
          .setDescription('เข้าร่วมเกม Avalon ที่เปิดอยู่'),
      )
      .addSubcommand((sub) =>
        sub
          .setName('leave')
          .setDescription('ออกจากเกม Avalon ที่เข้าร่วมอยู่'),
      )
      .addSubcommand((sub) =>
        sub
          .setName('start')
          .setDescription('เริ่มเกม Avalon (สุ่มบทบาท)'),
      )
      .addSubcommand((sub) =>
        sub
          .setName('status')
          .setDescription('เช็คสถานะเกม Avalon ในช่องนี้'),
      )
      .addSubcommand((sub) =>
        sub
      ...
      .addSubcommand((sub) =>
        sub
          .setName('cancel')
          .setDescription('ยกเลิกเกม Avalon ในช่องนี้ (เฉพาะเจ้าห้อง)'),
      ),
    /**
     * @param {import('discord.js').ChatInputCommandInteraction} interaction
     * @param {import('../game/AvalonGameManager.js').AvalonGameManager} gameManager
     */
